                        ...
                        <table class="table">
                            ...
                            <?php if(count($arrNews)): ?>
                                ...
                                <tr>
                                    ...
                                    <td><img src="<?php echo base_url('static/admin/img/news/' . $new->avatar); ?>" style="width: 200px; height: 100px" /></td>
                                    <td><?php echo $status; ?></td>
                                    <td>
                                    <button class="btn btn-danger btn-remove" data-id="<?php echo $new->id; ?>">Xóa</button>
                                    </td>
                                </tr>
                            <?php }?>
            ...
            swal({
                ...
                preConfirm: function () {
                    return new Promise(function (resolve, reject) {
                        ...
                        $.ajax({
                            url: '<?php echo base_url("admin/news/remove"); ?>',
                            type: 'GET',
                            dataType: 'JSON',
                            data: {
                                id: id
